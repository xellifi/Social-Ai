        ...
        <div className="lg:col-span-7 space-y-6 md:overflow-y-auto custom-scrollbar md:pr-2">
          <div className="bg-surface border border-slate-700 rounded-2xl p-6 space-y-5">
              ...
              <div>
                ...
                <div className="flex gap-2 bg-slate-900 p-1 rounded-lg border border-slate-700">
                    <button 
                      ...
                      className={`flex-1 py-2 rounded-md text-sm flex items-center justify-center gap-2 ${mediaType === 'text' ? 'bg-slate-700 text-white shadow-sm' : 'text-slate-400 hover:text-white'}`}
                    >Text</button>
                    <button 
                      onClick={() => setMediaType('image')}
                      className={`flex-1 py-2 rounded-md text-sm flex items-center justify-center gap-2 ${mediaType === 'image' ? 'bg-slate-700 text-white shadow-sm' : 'text-slate-400 hover:text-white'}`}
                    ><ImageIcon size={16}/></button>
                    <button 
                      onClick={() => setMediaType('video')}
                      className={`flex-1 py-2 rounded-md text-sm flex items-center justify-center gap-2 ${mediaType === 'video' ? 'bg-slate-700 text-white shadow-sm' : 'text-slate-400 hover:text-white'}`}
              ...
              <div className="relative">
                ...
                {mediaType === 'image' && (
                  <button 
                    ...
                    className="absolute bottom-3 right-3 bg-secondary hover:bg-purple-600 text-white px-3 py-1.5 rounded-lg text-xs transition-colors flex items-center gap-2 font-medium shadow-lg shadow-purple-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                ...
                {mediaType === 'text' && (
                   <button 
                    ...
                    className="absolute bottom-3 right-3 bg-primary hover:bg-indigo-600 text-white px-3 py-1.5 rounded-lg text-xs transition-colors flex items-center gap-2 font-medium shadow-lg shadow-indigo-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
               ...
               <div className="relative group">
                  ...
                  <div className="absolute bottom-3 right-3">
                     <button 
                        ...
                        disabled={isGeneratingCaption || !prompt || !selectedApiProvider}
                        className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-lg text-xs font-medium transition-colors shadow-lg flex items-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
                     >
            ...
            <button 
              ...
              className="w-full bg-primary hover:bg-indigo-600 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-indigo-500/20"
            >
