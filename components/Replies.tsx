        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto items-center">
          ...
          <div className="flex bg-slate-900 rounded-lg p-1 border border-slate-700 w-full sm:w-auto">
             <button 
                ...
                className={`flex-1 sm:flex-none px-6 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'comment' ? 'bg-slate-700 text-white shadow-sm' : 'text-slate-400 hover:text-white'}`}
             >Comments</button>
             <button 
                onClick={() => setActiveTab('dm')}
                className={`flex-1 sm:flex-none px-6 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'dm' ? 'bg-slate-700 text-white shadow-sm' : 'text-slate-400 hover:text-white'}`}
             >Messages</button>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap w-full sm:w-auto">
            ...
            <div className="flex items-center justify-between sm:justify-start gap-3 bg-slate-900/50 px-4 py-2.5 rounded-lg border border-slate-700 w-full sm:w-auto shrink-0">
               ...
               <button 
                  ...
                  className={`w-11 h-6 rounded-full relative transition-colors ${useAi ? 'bg-primary' : 'bg-slate-600'}`}
               >
                 <span className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform ${useAi ? 'translate-x-5' : 'translate-x-0'}`}></span>
               </button>
            </div>
        </div>
      </div>
               ...
               {availableProviders.length > 0 ? (
                 <>
                   ...
                   <button 
                      ...
                      className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-5 py-2.5 rounded-xl font-medium transition-colors shadow-lg shadow-purple-500/20"
                   >
                 ...
                 <div className="flex flex-col items-center text-center max-w-md mx-auto">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-white px-5 py-2.5 rounded-xl font-medium transition-colors border border-slate-600 hover:border-slate-500 shadow-lg shadow-black/20"
                    >
                      <Settings size={18} />
            ...
            <div className="p-6 flex flex-col h-full">
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                     ...
                     />
                     <button className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-indigo-600 text-white px-5 py-3 rounded-xl font-medium transition-colors shadow-lg shadow-indigo-500/20">
